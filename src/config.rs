...
impl OdooInstance {
    ...
    pub(crate) fn policy_decision(
        ...
        self.policy_decision_for_model(tool, "", global_default_mode)
    }

    pub(crate) fn policy_decision_for_model(
        &self,
        tool: ToolName,
        model: &str,
        global_default_mode: &str,
    ) -> PolicyDecision {
        self.policy_decision_for_request(tool, model, None, &[], global_default_mode)
    }
...
pub struct GlobalSettings {
    ...
    #[serde(default = "default_max_domain_terms")]
...
fn default_max_domain_terms() -> usize {
    100
}
