...
- [x] S1-04 — Add authentication and authorization error categories.
- [x] S1-05 — Add Odoo validation and access-error categories.
- [x] S1-06 — Add transport, timeout, and protocol-error categories.
- [x] S1-07 — Add stable machine-readable error codes.
- [x] S1-08 — Add retryability classification.
- [x] S1-09 — Create a structured MCP error response.
- [x] S1-10 — Migrate one read tool as the reference implementation.
...
- [x] S1-15 — Use a unique JSON-RPC request ID.
- [x] S1-16 — Validate HTTP status before parsing the response.
...
- [x] S1-23 — Add timeout, malformed-response, and HTTP-failure tests.

## 1.3 Safe retry foundation

- [x] S1-24 — Create retry classifications by operation class.
- [x] S1-25 — Add exponential backoff with jitter.
...
- [x] S2-03 — Add a default query limit.
- [x] S2-04 — Add a configurable maximum query limit.
- [x] S2-05 — Reject negative offsets and invalid limits.
...
- [x] S3-04 — Separate actor identity from agent identity.
- [x] S3-05 — Define trusted and untrusted identity sources.
- [x] S3-06 — Propagate request context through every executor.
- [x] S3-07 — Add identity-propagation tests.

## 3.2 Secret handling

- [x] S3-08 — Define a `SecretProvider` abstraction.
- [x] S3-09 — Use a redacted secret type for Odoo credentials.
- [x] S3-10 — Prevent debug output and serialization from disclosing secrets.
- [x] S3-11 — Add an environment-backed secret provider.
...
- [x] S3-16 — Create typed read/create/update/delete capabilities.
...
- [x] S3-21 — Add per-model permissions.
- [x] S3-22 — Add per-operation permissions.
- [x] S3-23 — Add field-level allow and deny rules.
...
- [x] S3-32 — Add scoped model, operation, field, and method policy editing.
- [x] S3-33 — Add default-deny guidance and client-side policy validation.
- [x] S3-34 — Add UI configuration regression tests and documentation.
...
- [x] S4-01 — Define a typed `Operation`.
...
- [x] S4-06 — Create a central `OperationExecutor`.
...
- [x] S4-11 — Add operation-lifecycle tests.
...
- [x] S4-23 — Add delete preview with affected records.
- [x] S4-24 — Add bulk-operation summary preview.
- [x] S4-25 — Validate write payloads against model metadata.
- [x] S4-26 — Mark computed and default values as estimates.
- [x] S4-27 — Document that preview is not a transactional dry run.
- [x] S4-28 — Add preview and validation tests.

## 4.4 Durable approval protocol

- [x] S4-29 — Define the approval-request schema.
- [x] S4-30 — Create an approval-storage abstraction.
- [x] S4-31 — Add an initial durable local implementation.
...
- [x] S4-36 — Enforce single-use execution.
- [x] S4-37 — Reject payload modifications after approval.
- [x] S4-38 — Add approval-timeout handling.
- [x] S4-39 — Add concurrency and replay tests.
- [x] S4-40 — Integrate an approval inbox into the admin UI.
...
- [x] S4-45 — Bind keys to payload hashes.
- [x] S4-46 — Add pending, succeeded, failed, and unknown states.
- [x] S4-47 — Return stored results for completed requests.
- [x] S4-48 — Reject key reuse with a different payload.
...
- [x] S4-53 — Define the verification-result schema.
- [x] S4-54 — Verify created records.
- [x] S4-55 — Verify updated fields.
- [x] S4-56 — Verify deleted-record absence.
- [x] S4-57 — Detect partial verification.
- [x] S4-58 — Distinguish execution success from verification success.
- [x] S4-59 — Add mismatch and unknown-state tests.
...
| Stage 4 — Safe Mutation Lifecycle | Complete | 59/59 | Sections 4.1–4.6 complete with operation, preview, approval, idempotency, and verification foundations. |
