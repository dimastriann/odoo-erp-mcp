...
- [ ] S0-01 — Align the Cargo, MCP `serverInfo`, UI, and documentation versions.
- [ ] S0-02 — Use `CARGO_PKG_VERSION` as the single runtime version source.
...
- [ ] S0-07 — Add CI unit and integration test execution.
- [ ] S0-08 — Add debug and release build verification.

## 0.2 Test infrastructure

- [ ] S0-09 — Create a reusable multi-instance configuration fixture.
- [ ] S0-10 — Create a mock Odoo JSON-RPC server.
...
- [ ] S0-16 — Separate tool declarations from the MCP request dispatcher.
- [ ] S0-17 — Create a typed `ToolName`.
- [ ] S0-18 — Create typed argument structures for read tools.
...
- [ ] S1-01 — Create the main internal error enum.
- [ ] S1-02 — Add an input-validation error category.
...
|---|---|---:|---|
| Stage 0 — Baseline Engineering and Testability | Not started | 0/23 | |
